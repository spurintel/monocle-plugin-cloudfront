 ...
 * limit. NOTE: the stripped artifact currently sits ~10235 bytes, only a few
 * bytes under the cap; the build (build.mjs) fails if it exceeds 10240 bytes, so
 * keep the interstitial and logic lean when editing.
 *
